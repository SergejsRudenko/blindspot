...
<link rel="stylesheet" type="text/css" media="all" href="assets/css/style.css?v=10">
...
<script type="text/javascript" src="assets/js/script.js?v=10"></script>
...
<header class="header">
    <div class="wrap">
        ...
        <div class="free-delivery-block">
            <p class="delivery-text">Free Shipping <span>in EU</span></p>
        </div>
        <p class="logo-text">Customizer</p>
    ...
    <div class="wrap relative">
        <div class="content content-left">
            <div class="uniform-wrap">
                ...
                <div class="uniform-svg svg-uniform-4" data-uniform="svg-uniform-4">

                    <?php echo file_get_contents("./assets/img/uniform-4.svg"); ?>

                </div>
                <div class="uniform-svg svg-uniform-3 hidden" data-uniform="svg-uniform-3">
                ...
                <div class="change-colors-wrap">
                    <a href="#" class="change-colors">Change colors</a>
                </div>
            </div>
            ...
            <form class="submit-form" method="POST" action="">
                ...
                <div class="input-field required required-select validate-select">
                    <label>Select size<span class="required-star">*</span></label>
                    <select name="size">
                        <option value="">Choose</option>
               ...
               <!--  <div class="input-field required required-select validate-select">
                ...
                <div class="checkbox-field printing-checkbox">
                    <label>
                        ...
                        <span class="label">Printing</span> <!-- (+25 EUR) -->
                ...
                <div class="total-wrap" data-main-price="350">
                    <p class="total-block">TOTAL: <span class="total">350</span> &euro;</p>
                    <a href="#" class="order-button blue-button">Checkout</a>
                    <p class="form-note">* - Required ﬁelds</p>
                </div>
            ...
            <?php require_once("sidebar-uniform-4.php"); ?>

            <div class="total-wrap">
                <p class="total-block">TOTAL: <span class="total"></span> &euro;</p>
                <a href="#" class="next-button blue-button">Next</a>
            </div>
        </div>
...
<div class="popup ">
    ...
    <div class="accepted-popup ">
        <div class="center">
            ...
            <p class="title">Thank you, order received!</p>
            <p class="text">You will receive information about<br><br>the payment terms in your e-mail.</p>
