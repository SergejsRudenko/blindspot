...
function sendEmail(){
	...
	if($c_uniform == "svg-uniform-1"){
		$body.= '<p><span class="title">Uniform: </span> <span>Original uniform</span></p>';
		if($c_design==1){
	...
	if($c_uniform == "svg-uniform-2"){
		$body.= '<p><span class="title">Uniform: </span> <span>New uniform</span></p>';
	}
	...
	if($c_uniform == "svg-uniform-2"){
		...
		$body.= '<p><span class="title">Jersey body/arms: </span> <span class="color-box" style="background-color: #'.$c_jersey.'"></span><span>#'.$c_jersey.'</span></p>';
		$body.= '<p><span class="title">Jersey edges: </span> <span class="color-box" style="background-color: #'.$c_jersey_2.'"></span><span>#'.$c_jersey_2.'</span></p>';
		$body.= '<p><span class="title">Elbow / armpit: </span> <span class="color-box" style="background-color: #'.$c_elbow_armpit.'"></span><span>#'.$c_elbow_armpit.'</span></p>';
		$body.= '<p><span class="title">Logo 1: </span> <span class="color-box" style="background-color: #'.$c_logo_1.'"></span><span>#'.$c_logo_1.'</span></p>';
		$body.= '<p><span class="title">Logo 2: </span> <span class="color-box" style="background-color: #'.$c_logo_3.'"></span><span>#'.$c_logo_3.'</span></p>';
		$body.= '<p><span class="title">Logo 3: </span> <span class="color-box" style="background-color: #'.$c_logo_4.'"></span><span>#'.$c_logo_4.'</span></p>';
		$body.= '<p><span class="title">Lines / trim: </span> <span class="color-box" style="background-color: #'.$c_lines.'"></span><span>#'.$c_lines.'</span></p>';
		$body.= '<p><span class="title">Thighs (upper leg part): </span> <span class="color-box" style="background-color: #'.$c_tights.'"></span><span>#'.$c_tights.'</span></p>';
		$body.= '<p><span class="title">Shins 1 (lower leg part): </span> <span class="color-box" style="background-color: #'.$c_shins.'"></span><span>#'.$c_shins.'</span></p>';
		$body.= '<p><span class="title">Shins 2 (lower leg part): </span> <span class="color-box" style="background-color: #'.$c_shins_2.'"></span><span>#'.$c_shins_2.'</span></p>';
		$body.= '<p><span class="title">Pants design elements: </span> <span class="color-box" style="background-color: #'.$c_shins_3.'"></span><span>#'.$c_shins_3.'</span></p>';
	...
	$mail->SetFrom("info@blindsave.com", $last_name." ".$first_name);
	// $mail->AddAddress("andris.knopkens@gmail.com", 'Blindsave customizer');     // Add a recipient
	// $mail->AddAddress("oskars.neilands@gmail.com", 'Blindsave customizer');     // Add a recipient
	...
	$body2.= '<p><img alt="Logo" src="https://customizer.blindsave.com/assets/img/blindsave-logo.svg"></p>';
	$body2.= "<p>* * *</p><br/><br/>";
