...
<script type="text/javascript" src="assets/js/script.js?v=9"></script>
        ...
        <div class="content content-left">
            <div class="uniform-wrap">
                ...
                <div class="change-colors-wrap">
                    <a href="#" class="change-colors">Farben ändern</a>
                </div>
            </div>
            ...
            <form class="submit-form" method="POST" action="">
                ...
                <div class="input-field required required-input validate-text">
                    <label>Vorname<span class="required-star">*</span></label>
                ...
                <div class="input-field required required-input validate-text">
                    <label>Strasse<span class="required-star">*</span></label>
                    <input type="text" name="address" value="">
                </div>
                <div class="input-field required required-input validate-text">
                    <label>Ort<span class="required-star">*</span></label>
                    <input type="text" name="city" value="">
                </div>
                <div class="input-field required required-input validate-text">
                    <label>PLZ<span class="required-star">*</span></label>
                ...
                <div class="input-field required required-select validate-select">
                    <label>Grösse wählen<span class="required-star">*</span></label>
                    <select name="size">
               ...
               <!--  <div class="input-field required required-select validate-select">
                ...
                <div class="input-field required required-input validate-text">
                    <label>Menge<span class="required-star">*</span></label>
                    <input type="text" name="quantity" value="">
                </div>
                <div class="checkbox-field printing-checkbox">
                    <label>
                        <span class="checkbox-icon"></span>
                        <span class="label">Aufdruck</span> <!-- (+25 EUR) -->
                ...
                <div class="total-wrap" data-main-price="469">
                    <!-- &euro; -->
                    <p class="total-block">TOTAL: <span class="total">469</span> CHF</p>
                    <a href="#" class="order-button blue-button">Bestellen</a>
            ...
            <div class="total-wrap">
                <!-- &euro; -->
                <p class="total-block">TOTAL: <span class="total"></span> CHF</p>
                <a href="#" class="next-button blue-button">Weiter</a>
            </div>
        </div>
