...
function createEmailBody() {
	...
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Name: </span> <span'.$ss.$pss.$se.'>'.$first_name.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Vorname: </span> <span'.$ss.$pss.$se.'>'.$last_name.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Telefonnummer: </span> <span'.$ss.$pss.$se.'>'.$phone.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>E-Mail: </span> <span'.$ss.$pss.$se.'>'.$email.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Strasse: </span> <span'.$ss.$pss.$se.'>'.$address.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Ort: </span> <span'.$ss.$pss.$se.'>'.$city.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>PLZ: </span> <span'.$ss.$pss.$se.'>'.$postal.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Land: </span> <span'.$ss.$pss.$se.'>'.$country.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Grösse: </span> <span'.$ss.$pss.$se.'>'.$size.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Menge: </span> <span'.$ss.$pss.$se.'>'.$quantity.'</span></p><br/>';

	if ($print){
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Aufdruck: </span> <span'.$ss.$pss.$se.'>Yes</span></p>';
	...
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Bemerkungen: </span> <span'.$ss.$pss.$se.'>'.$comments.'</span></p>';
	$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Total: </span> <span'.$ss.$pss.$se.'>'.$total_price.' CHF</span></p>';
	...
	if($c_uniform == "svg-uniform-1"){
		...
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Farbe Schienbein: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_shins.'"></span><span'.$ss.$pss.$se.'>#'.$c_shins.'</span></p>';
	...
	if($c_uniform == "svg-uniform-2"){
		...
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Farbe Brust und Arme: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_jersey.'"></span><span'.$ss.$pss.$se.'>#'.$c_jersey.'</span></p>';
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Farbe Seite und Hände: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_jersey_2.'"></span><span'.$ss.$pss.$se.'>#'.$c_jersey_2.'</span></p>';
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Farbe Ellbogen: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_elbow_armpit.'"></span><span'.$ss.$pss.$se.'>#'.$c_elbow_armpit.'</span></p>';
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Logo 1: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_logo_1.'"></span><span'.$ss.$pss.$se.'>#'.$c_logo_1.'</span></p>';
		...
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Farbe piping: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_lines.'"></span><span'.$ss.$pss.$se.'>#'.$c_lines.'</span></p>';
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Farbe Hosen oberer Teil: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_tights.'"></span><span'.$ss.$pss.$se.'>#'.$c_tights.'</span></p>';
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Farbe Schienbein 1: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_shins.'"></span><span'.$ss.$pss.$se.'>#'.$c_shins.'</span></p>';
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Farbe Schienbein 2: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_shins_2.'"></span><span'.$ss.$pss.$se.'>#'.$c_shins_2.'</span></p>';
		$body.= '<p><span class="title"'.$ss.$title_class_style.$pss.$se.'>Farbe Seitenteile: </span> <span class="color-box" style="'.$color_box_style.'background-color: #'.$c_shins_3.'"></span><span'.$ss.$pss.$se.'>#'.$c_shins_3.'</span></p>';
